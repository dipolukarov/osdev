...
#define FS_MOUNTPOINT	0x08 // Is the file an active mounpoint?
...
typedef struct fs_node
{
	...
	u32int		mask;		// The permission mask.
	u32int		uid;		// The owning user.
	u32int		gid;		// The owning group.
	u32int		flags;		// Includes one node type. See #defines above.
	...
	struct fs_node	*ptr;		// Used by mounpoints and symlinks.
} fs_node_t;
